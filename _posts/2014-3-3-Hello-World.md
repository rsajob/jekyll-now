...
На днях немного начал разбираться c Consul. Основная загвоздка в том, что он по умаолчанию предназначен для работы на нескольких нодах, а мне нужно было завести его в основном чисто для service-discovery в рамках одного проекта на одном сервере в Docker.
